...
#define LOG_FORMAT_OGG ((brrlog_formatT){LOG_PARAMS_OGG})
...
#define LOG_FORMAT_WEM ((brrlog_formatT){LOG_PARAMS_WEM})
...
#define LOG_FORMAT_WSP ((brrlog_formatT){LOG_PARAMS_WSP})
...
#define LOG_FORMAT_BNK ((brrlog_formatT){LOG_PARAMS_BNK})
...
#define LOG_FORMAT_AUT ((brrlog_formatT){LOG_PARAMS_AUT})
...
#define LOG_FORMAT_SUCCESS ((brrlog_formatT){LOG_PARAMS_SUCCESS})
...
#define LOG_FORMAT_FAILURE ((brrlog_formatT){LOG_PARAMS_FAILURE})
...
#define LOG_FORMAT_DRY ((brrlog_formatT){LOG_PARAMS_DRY})
...
#define LOG_FORMAT_WET ((brrlog_formatT){LOG_PARAMS_WET})
...
#define LOG_FORMAT_MANUAL ((brrlog_formatT){LOG_PARAMS_MANUAL})
...
#define LOG_FORMAT_INPLACE ((brrlog_formatT){LOG_PARAMS_INPLACE})
...
#define LOG_FORMAT_SEPARATE ((brrlog_formatT){LOG_PARAMS_SEPARATE})
...
#define LOG_FORMAT_ENABLED ((brrlog_formatT){LOG_PARAMS_ENABLED})
...
#define LOG_FORMAT_DISABLED ((brrlog_formatT){LOG_PARAMS_DISABLED})
...
#define LOG_FORMAT_PATH ((brrlog_formatT){LOG_PARAMS_PATH})
...
#define LOG_FORMAT_INFO ((brrlog_formatT){LOG_PARAMS_INFO})
