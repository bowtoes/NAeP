 ...
 * Declares the function 'riff_cc_ename(_subname)(brru4 cc)', which matches the given FourCC to a given
...
#define _enum_boiler(_ename_,_subname_)\
    ...
    extern const brru4 riff_ ##_ename_## _ccs[riff_ ##_ename_## _count - 1];\
    riff_ ##_ename_##_subname_## _t riff_cc_ ##_ename_## _subname_(brru4 cc);
...
unsigned char *riff_datasync_buffer(riff_datasync_t *const datasync, brrsz size);
...
void riff_chunkstate_zero(riff_chunkstate_t *const chunkstate);
 ...
 * */
int riff_consume_chunk(riff_t *const riff, riff_chunkstate_t *const chunkstate, riff_datasync_t *const datasync);
